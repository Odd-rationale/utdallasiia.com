...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('jobpostings_jobposting', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
            ('job_title', self.gf('django.db.models.fields.CharField')(max_length=30)),
            ...
            ('skill_experience', self.gf('django.db.models.fields.TextField')()),
            ('company_description', self.gf('django.db.models.fields.TextField')()),
            ('status', self.gf('django.db.models.fields.IntegerField')(default=0)),
        ))
        db.send_create_signal('jobpostings', ['JobPosting'])


    def backwards(self, orm):
        # Deleting model 'JobPosting'
        db.delete_table('jobpostings_jobposting')
    ...
    models = {
        ...
        'jobpostings.jobposting': {
            ...
            'job_title': ('django.db.models.fields.CharField', [], {'max_length': '30'}),
            'skill_experience': ('django.db.models.fields.TextField', [], {}),
